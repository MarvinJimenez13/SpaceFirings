...
public class Asteroid2 {
    ...
    public Asteroid2(int x, int y){
        ...
        numberX = new Random();
        asteTexture = new Texture("asteanim2.png");
        aniAste = new Animation(new TextureRegion(asteTexture), 20, 1.1f);
        bounds = new Rectangle(position.x, position.y, Gdx.graphics.getWidth()/4, Gdx.graphics.getHeight()/6.6f);
